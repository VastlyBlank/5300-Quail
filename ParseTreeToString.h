...
private:
	...
	// sub-expressions
	static std::string get_operator_string(const hsql::Expr* expr);
	static std::string get_expression_string(const hsql::Expr* expr);
	static std::string get_table_information(const hsql::TableRef* table);
